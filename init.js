...
function replaceFileContent(filePath) {
  ...
  let newContent = content.replaceAll(`blog.techidaily.com`, `${subDomainName}.techidaily.com`);
  newContent = newContent.replaceAll(`site-blog.git`, `site-${subDomainName}.git`);
